class CongressionalDistricts extends React.Component {
  ...
  componentWillMount() {
    d3.queue()
      .defer(d3.json, "https://ar123456.github.io/d3Data/congDist/us.json")
      .defer(
        d3.json,
        "https://ar123456.github.io/d3Data/congDist//us-congress-113.json"
      )
  ...
  render() {
    return React.createElement(
      ...
      React.createElement(
        ...
        React.createElement(CongressionalDistricts, { width: 960, height: 600 })
      )
    );
  }
}
